...
time.sleep(1)
os.system("clear")
print ('''Loading API  [##========] 13%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [###=======] 29%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [####======] 42%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [#####=====] 50%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [######====] 68%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [#######===] 72%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [########==] 84%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [#########=] 99%''')
time.sleep(1)
os.system("clear")
print ('''Loading API  [##########] 100%''')
time.sleep(2)
os.system("clear")
...
print ('''                      ╔═════════════════════════════╗''')
print ('''                                 ▄︻̷̿┻̿═━一''')
print ('''                         Edit BY: Nattawut Saenjai''')
print ('''                      ╚═════════════════════════════╝''')
...
print ("\n\n     [✕] กระสุนปืนของท่านหมดแล้วค่ะ!!   ▄︻̷̿┻̿═━一")
